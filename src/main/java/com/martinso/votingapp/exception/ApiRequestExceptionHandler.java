...
public class ApiRequestExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<?> ApiRequestException(ApiRequestException e){
    ...
    protected ResponseEntity <?> handleMethodArgumentException(
        ...
        InvalidRequestBodyExceptionResponse response =  InvalidRequestBodyExceptionResponse.builder()
                .data(data)
                .message("Bad Request")
                .status(status)
